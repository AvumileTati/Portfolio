...
const restoredSlider = `<div class="slider-container">
                    <div class="slide project-slide-stagger" style="opacity: 0; transform: translateY(50px); transition: all 0.6s cubic-bezier(0.25, 0.85, 0.15, 1.15);">
                        <div class="slide-image live-preview-wrapper" style="position: relative; overflow: hidden; background: #111;">
...
if (html.match(sliderRegex)) {
    html = html.replace(sliderRegex, restoredSlider);
    fs.writeFileSync('Avumile Tati Portfolio/index.html', html);
    console.log("Restored original iframe layout on index.html slider.");
}
